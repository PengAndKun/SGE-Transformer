...
def run_ros2_style_control():
    ...
    # 10_e. 控制参数 (模拟 ROS 10_e cmd_vel 的限制)
    ...
    plt.title("ROS 10_e Style Control (Body Frame Velocity)")
    ...
    try:
        while True:
            ...
            # --- B. 模拟 ROS 10_e Twist 消息 (机体坐标系速度) ---
            # 默认为 0 (松手即停，带有阻尼感)
            cmd_vel_body_x = 0.0
            cmd_vel_body_y = 0.0
            cmd_vel_z = 0.0
            ...
            # 10_e. 将 机体速度 (Body Vel) 转换到 世界速度 (World Vel)
            # 旋转矩阵公式:
