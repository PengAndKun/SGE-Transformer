...
def main():
    # 确保读取的是修复后的文件
    filename = "../../data_pybullet/3d_trajectories/hybrid/hybrid_trajectories_batches_8_budget_50000.pkl"
    filename = "../../data_pybullet/3d_trajectories/hybrid_random/hybrid_random_trajectories_batches_8_budget_50000.pkl"

    # filename = "sge_full_state_trajectories_with_obs20_2.pkl"

    if not os.path.exists(filename):
        print(f"Error: {filename} not found.")
        print("请先运行修复版的提取脚本 sge_full_state_trajectories_with_ceiling.py")
        return
