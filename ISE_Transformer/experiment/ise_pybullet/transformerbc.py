...
class BCTrainer:
    ...
    def learn(self, state_sequences, action_sequences, batch_size, num_epochs: int):
        ...
        for epoch in epoch_pbar:
            ...
            batch_sequences = all_state_sequences[sample_indices].to(self.device)
            batch_targets = all_action_sequences[sample_indices].to(self.device)
...
if __name__ == "__main__":
    # 配置参数
    PKL_FILE = "elite_trajectories_v1_top_2.pkl"
